...
contract ERC1155PawnShop is IPawnShop, Ownable, Pausable, ReentrancyGuard, IERC1155Receiver {
        ...
        onlyCycleNoGreaterThanZero(_borrowCycleNo)
    {
        ...
        IERC1155(_collection).safeTransferFrom(msg.sender, address(this), _tokenId, 1, "0x");
        ...
        nonReentrant
    {
        ...
        IERC1155(_collection).safeTransferFrom(address(this), msg.sender, _tokenId, 1, "0x");
